    ...
    <div className="bg-white rounded-xl shadow-lg p-6">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {filteredData.map((item, index) => (
              <tr key={`${item.kabupaten}-${item.provinsi}`} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="text-sm text-gray-900">{item.provinsi}</div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center">
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="text-sm text-gray-900">{item.total_hewan} ekor</div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="text-sm text-gray-900">{item.total_daging.toFixed(1)} kg</div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
      ...
      {filteredData.length === 0 && !loading && (
        <div className="text-center py-12">
          ...
          <p className="text-gray-500">Tidak ada data distribusi ditemukan</p>
        </div>
      )}
    </div>
  );
